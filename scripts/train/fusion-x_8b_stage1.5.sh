...
mkdir -p $SCRIPT_DIR/../../playground/training/training_dirs/$MEDIUM_NAME
...
srun -p Your Partion \
    ...
    --version llama_3 \
    --data_path $SCRIPT_DIR/yaml/stage1.5.yaml \
    ...
    --bf16 True \
    --output_dir $SCRIPT_DIR/../../playground/training/training_dirs/$MEDIUM_NAME \
    ...
    --report_to none \
    2>&1 | tee $SCRIPT_DIR/../../playground/training/training_dirs/$MEDIUM_NAME/output.log'